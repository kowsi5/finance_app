...
import 'package:finance_app/views/daily/customeractiveinfo.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

class Usergetinfo extends StatefulWidget {
  final String collectiontype;
  const Usergetinfo({super.key, required this.collectiontype});

  @override
  _UsergetinfoState createState() => _UsergetinfoState();
}

class _UsergetinfoState extends State<Usergetinfo> {
  ...
  _handleLoginUser(
      BuildContext buildContext, String mobile, String date) async {
    print(" $date ");
