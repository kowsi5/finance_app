...
Todayreport todayreportFromJson(String str) =>
    Todayreport.fromJson(json.decode(str));

String todayreportToJson(Todayreport data) => json.encode(data.toJson());
...
class Todayreport {
  ...
  factory Todayreport.fromJson(Map<String, dynamic> json) => Todayreport(
        id: json["id"],
        name: json["name"],
        mobile: json["mobile"],
        empid: json["empid"],
